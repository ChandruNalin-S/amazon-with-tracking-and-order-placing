...
Field is also called property.


*/

class Cart {
  cartItems;//property and cartItems = indefined; and without # this property is called public property and it can access or use any where like inside and outside the class.
 
  #localStorageKey;// this # used to create a private property and it only access/use inside the class not outside the class. other's cannot change the value from outside the class.
