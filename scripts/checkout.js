...
function renderOrderSummary(){// this renderOrderSummary function is used for generate all the below code and to avoid reload the page when clicking deliveryOption in checkout page.
...
// the above is for update the data and regenerate all the html.
